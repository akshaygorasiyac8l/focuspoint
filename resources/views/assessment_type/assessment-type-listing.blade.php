                        ...
                        <div class="col-md-3" id="header-btn-section">
                          <ul class="new-dropdown-hover">
                            <li class="droupdown-hover-add">
                              <a href="{{ route('assessment-type-add') }}" class="btn btn-info" id="header-new-btn">New</a>    
                            </li>
                            <!--
                            <li>
                                ...
                                @if (count($assessment_types) > 0)
                                    @foreach ($assessment_types as $assessment_type)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('assessment-type-edit', $assessment_type->id) }}" class="name-class">{{ $assessment_type->title }}</a></td>
