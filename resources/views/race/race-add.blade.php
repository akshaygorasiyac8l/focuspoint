                     ...
                     <div class="container-fluid">
                        <div class="row">
                           <div class="col-md-12 page-background">
                              <h1 class="page-title">New Race</h1>
                           </div>
                        </div>
                     </div>
                  </section>
                                    ...
                                    <div class="col-md-9">
                                       <div class="row">
                                          <div class="col-md-12 time-add">
                                             <input type="text" name="title" class="form-control "  placeholder="Race" required>
                                          </div>
                  ...
                  <section class="footer-section">
                     <div class="container-fluid">
                        <div class="card-footer">
                           ...
                           <a href="{{ route('races') }}" class="btn btn-default float-right">Cancel</a>
                         </div>
                     </div>
                  </section>
               </div>
