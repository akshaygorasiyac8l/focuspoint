                     ...
                     <div class="container-fluid">
                        <div class="row">
                           <div class="col-md-12 page-background">
                              <h1 class="page-title">Edit Consumer Note Type</h1>
                           </div>
                        </div>
                     </div>
                  </section>
                           ...
                           <div class="col-md-8 consumer-section">
                              <div class="card card-primary">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Consumer Note Type</label>
                                    <div class="col-md-9">
                                       <div class="row">
                                          <div class="col-md-12 time-add">
                                             <input type="text" name="title" class="form-control "  placeholder="Consumer Note Type" value="{{$consumer_note_type->title}}" required>
                                          </div>
                  ...
                  <section class="footer-section">
                     <div class="container-fluid">
                        <div class="card-footer">
                           ...
                           <a href="{{ route('consumer-note-types') }}" class="btn btn-default float-right">Cancel</a>
                         </div>
                     </div>
                  </section>
               </div>
