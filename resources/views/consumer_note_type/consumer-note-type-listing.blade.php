            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Consumer Note Type</h3>
...
@section('end_listing_layout')
    ...
    $(document).ready(function() {
        ...
        $('#table-general1').DataTable({
            ...
            "searching": true,
            "ajax": {
                "url": "{{ route('getconsumernotetypes') }}",
                "method": "GET",
                "cache": false,
            ...
            "columnDefs": [
                ...
                {"orderable": false, "targets": [0]} // Can't order
          ...
          $('html').on('click', '.deletedata', function () {
                ...
                if(confirm("Are You sure want to delete !")){
                  $.ajax({
                      type: "get",
                      url: "{{ url('deleteconsumernotetype') }}/"+id,
            ...
            $('html').on('click', '.savedata', function () {
                ...
                if(id!=''){
                    ...
                    var url = "{{ url('consumernotetypeedit') }}";
                }else{
                    var url = "{{ url('consumernotetypeadd') }}";
                    var dataValues = { 
                        title: title,
            ...
            $('html').on('click', '.editdata', function () {
                ...
                var id = $(this).attr('data');
                $.ajax({
                  url: "{{ url('consumernotetypebyid') }}/"+id,
                  type: "GET",
                  success: function (data) {
