                              ...
                              <div class="card card-primary">
                                    ...
                                    <div class="col-md-9">
                                       <div class="row">
                                          <div class="col-md-12 time-add">
                                             <input type="text" name="role" class="form-control "  placeholder="Role" value="{{$role->role}}" required>
                                          </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-9 common-text">
                                       <select class="form-control droupdown width-add" name="status" required>
                                          <option value="" selected="selected" disabled="disabled">Select Status</option>
                                          <option <?php if($role->status=='1') { echo "selected";}?> value="1"> Enable</option>
                  ...
                  <section class="footer-section">
                     <div class="container-fluid">
                        <div class="card-footer">
                           ...
                           <a href="{{ route('roles') }}" class="btn btn-default float-right">Cancel</a>
                         </div>
                     </div>
                  </section>
               </div>
