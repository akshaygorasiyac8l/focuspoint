                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-md-9 time-add">
                                          <input type="text" name="dob" class="form-control date-select width-add dob" id="datetimepicker4" placeholder="yyyy-mm-dd">
                                       </div>
                                    </div>
                                    <div class="form-group row">
                              ...
                              <div class="card card-primary">
                                 <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-md-8 common-textbox">
                                          <input type="text" name="termination-date" class="form-control termination-date" placeholder="">
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-md-8 common-textbox">
                                          <input type="text" name="dl-expiration" class="form-control dl-expiration" placeholder="">
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                       <label class="col-md-4 col-form-label">DL State</label>
                                       <div class="col-md-8 common-textbox">
                                          <input type="text" name="dl-state" class="form-control dl-state" placeholder="">
                                       </div>
                                    </div>                                    
                                 </div>
                              </div>
