                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-md-8 common-textbox">
                                          ...
                                          @if($qualifications==''  || $qualifications=='N;')
                                          @else
       ...
       @foreach($contacts as $contact)
        ...
        empData += '<tr class="tr-contact-person common-tr-info">'+
               ...
               empData += '</select>'+
                        ...
                        '</td>'+
                        '<td>'+
                           '<input type="text" name="address-1" value="{{ $contact->address1 }}" class="form-control custom-contact-field common-text-box-new address_1" placeholder="">'+
                        '</td>'+
                        '<td>'+
                           '<input type="text" name="address-2" value="{{ $contact->address2 }}" class="form-control custom-contact-field common-text-box-new address_2" placeholder="">'+
                        '</td>'+
                        '<td>'+
                           '<input type="text" name="city" value="{{ $contact->city }}" class="form-control custom-contact-field common-text-box-new city_id" placeholder="">'+
                        '</td>'+
                        '<td>'+
                           '<select class="form-control droupdown custom-contact-field common-text-box-new state_id" name="state">'+
                             '<option>Select</option>';
               @foreach ($states as $state)      
               empData += '<option {{ $contact->state_id == $state->id ? 'selected' : ''}} value="{{$state->id}}">{{$state->name}}</option> ';
               @endforeach
               ...
               empData += '</select>'+
                        ...
                        '<td>'+
                           '<select class="form-control droupdown custom-contact-field common-text-box-new country_id" name="country">'+
                              '<option>Select</option>';
               @foreach ($countries as $country)      
               empData += '<option {{ $contact->country_id == $country->id ? 'selected' : ''}} value="{{$country->id}}">{{$country->name}}</option> ';
               @endforeach
